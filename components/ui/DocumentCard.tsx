...
export default function DocumentCard({
  ...
  return (
    <div className="bg-[#f8fafd] rounded-xl p-5 shadow-sm w-full max-w-md border border-[#eaecef]">
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <span className="text-sm text-gray-500 font-medium">{websiteName}</span>
      </div>
